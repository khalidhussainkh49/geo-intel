...
export function AppShell() {
    ...
    useEffect(() => {
        const startPlatform = async () => {
            ...
            pluginRegistry.register(new CustomsOfficesPlugin());
            pluginRegistry.register(new CustomsCheckpointsPlugin());
            pluginRegistry.register(new GeoNewsPlugin());               // ← NEW
    ...
    return (
        <div className="app-shell">
            ...
            {/* GeoNews alert toasts + alerts panel  ← NEW */}
            <GeoNewsAlertOverlay />
        </div>
    );
}
