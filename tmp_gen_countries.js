...
const csvData = \`country,latitude,longitude,name
...
LT,55.169438,23.881271,Lithuania
...
MP,15.097903,145.6739,"Northern Mariana Islands"
...
MY,4.140634,101.975766,Malaysia
...
SH,-24.143474,-10.028055,"Saint Helena"
...
UM,19.2833,-166.65,"U.S. Minor Outlying Islands"
...
WF,-13.294408,-176.204327,"Wallis and Futuna"
...
for (let i = 1; i < lines.length; i++) {
    ...
    if (line.includes('"')) {
        ...
        const name = line.substring(firstQuote + 1, lastQuote);
        const prefix = line.substring(0, firstQuote - 1).split(',');
        parts = [...prefix, name];
    } else {
        parts = line.split(',');
    }
...
const content = \`export interface CountryData {
    id: string;
    isoCode: string;
    name: string;
    lat: number;
...
export const COUNTRIES: CountryData[] = \${JSON.stringify(results, null, 4)};\`;
